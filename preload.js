...
class Preload extends Phaser.Scene {
    ...
    create() {
        ...
        gameState.bonusCards = [
            ...
            {key: 'chemicalWarfare',    type: 'permanent',      cost: 2, stancePoints: 0, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, reduceTargetArmor: 0, reduceTargetStrength: 0, drawCard: 0, turnsToDepletion: 4, token: 'chemicalWarfareToken'},
            ...
            {key: 'seppuku',            type: 'buff',           cost: 1, stancePoints: 0, damage: 0, fire: 0, poison: 0, heal: () => - Math.round(gameState.player.healthMax * 0.05), poisonRemove: 0, strength: () => gameState.player.stancePoints < 0 ? 2 - gameState.player.stancePoints : 2, armor: 0, reduceTargetArmor: 0, reduceTargetStrength: 0, drawCard: 0},
            ...
            {key: 'rebelLife',          type: 'buff',           cost: 0, stancePoints: 1, damage: 0, fire: 0, poison: 0, heal: () => (gameState.player.stancePoints < 0) ? 2 : 0, poisonRemove: 0, strength: 0, armor: 10, reduceTargetArmor: 0, reduceTargetStrength: 0, drawCard: 0},
