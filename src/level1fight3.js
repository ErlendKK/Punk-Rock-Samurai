...
class Level1Fight3 extends BaseScene {
    ...
    preload() {
        const assets = [
            { key: 'bakgrunnCity3', path: '../assets/images/backgrounds/bakgrunnCity3.jpg', loaded: false },
            { key: 'police1', path: '../assets/images/sprites/police1.png', loaded: false },
            { key: 'police2', path: '../assets/images/sprites/police2.png', loaded: false },
        ];
    ...
    create() {
        ...
        gameState.enemy1.actions = [
            ...
            new Action({ enemy: 1, pattern: 'even', damage: 12 }).setKey(""),
            new Action({ enemy: 1, pattern: 'odd', heal: 10, strength: 3 }).setKey(`Intends to\nApply a buff`),
        ];
        ...
        gameState.enemy2.actions = [
            ...
            new Action({ enemy: 2, pattern: 'oneInThree', damage: 13 }).setKey(""),
            new Action({ enemy: 2, pattern: 'twoInThree', heal: 10, strength: 3 }).setKey(`Intends to\nApply a buff`),
            new Action({ enemy: 2, pattern: 'threeInThree', damage: 15 }).setKey(""),
        ]
        ...
        function displayCountdownBox() {
            ...
            const turnsTextConfig = {fontSize: '80px', fontWeight: 'bold', fill: '#000000'};
            gameState.turnsTextBox = self.add.rectangle(825, 225, 83, 83, 0xffffff).setAlpha(0.30).setOrigin(0.5);  
            gameState.turnsText = self.add.text(825, 230, `${turnsTillPoliceArrive}`, turnsTextConfig).setOrigin(0.5);
        }
        ...
        */ 
        ...
        async function initiateEnemyTurnOneEvent() {
            ...
            const textConfig = {fontSize: '60px', fill: '#ff0000', fontWeight: 'bold' };
