...
class Level4Fight1 extends BaseScene {
    ...
    preload() {
        const assets = [
            { key: 'bakgrunnFortress1', path: '../assets/images/backgrounds/bakgrunnFortress1.jpg', loaded: false },
            { key: 'theFortress', path: '../assets/images/backgrounds/theFortress.jpg', loaded: false },
            { key: 'monster1', path: '../assets/images/sprites/monster1.png', loaded: false },
    ...
    create() {
        ...
        async function initiatePlayersTurnOneEvent() {
            ...
            const textConfig = { fontSize: '55px', fill: '#ff0000', fontWeight: 'bold' };
