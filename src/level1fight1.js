...
class Level1Fight1 extends BaseScene {
    ...
    preload() {
        const assets = [
            { key: 'theCity', path: '../assets/images/backgrounds/theCity.jpg', loaded: false },
            { key: 'bakgrunnCity1', path: '../assets/images/backgrounds/bakgrunnCity1.jpg', loaded: false },
            { key: 'nazi', path: '../assets/images/sprites/nazi.png', loaded: false }
        ];
    ...
    create() {
        ...
        gameState.enemy1.actions = [
            // Predetermined turns
            new Action({ enemy: 1, turn: 1, heal: 10, armor: 5 }).setKey(`Intends to\nApply a buff`),
            new Action({ enemy: 1, turn: 2, damage: 15 }).setKey(""),
            new Action({ enemy: 1, turn: 3, heal: 10, strength: 3 }).setKey(`Intends to\nApply a buff`),
            new Action({ enemy: 1, turn: 4, damage: 15 }).setKey(""),

            // Random turns
            new Action({ enemy: 1, damage: 15, probability: 0.50 }).setKey(""),
            new Action({ enemy: 1, damage: 17, probability: 0.20 }).setKey(""),
            new Action({ enemy: 1, heal: 10, armor: 3, probability: 0.15 }).setKey(`Intends to\nApply a buff`),
            new Action({ enemy: 1, heal: 10, strength: 2, probability: 0.15 }).setKey(`Intends to\nApply a buff`),
        ];
