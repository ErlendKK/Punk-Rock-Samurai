...
class Level2Fight1 extends BaseScene {
    ...
    preload() {
        const assets = [
            { key: 'theForest', path: '../assets/images/backgrounds/theForest.jpg', loaded: false },
            { key: 'bakgrunnForest1', path: '../assets/images/backgrounds/bakgrunnForest1.jpg', loaded: false },
            { key: 'tree1', path: '../assets/images/sprites/tree1.png', loaded: false },
            { key: 'tree2', path: '../assets/images/sprites/tree2.png', loaded: false },
            { key: 'rooted', path: '../assets/images/cards/rooted.jpg', loaded: false }
        ];
    ...
    create() {
        ...
        gameState.enemy1.actions = [
            // Predetermined turns
            new Action({ enemy: 1, turn: 1, debuffCard: 'discard' }).setKey(`Intends to\nApply a debuff`),
            new Action({ enemy: 1, turn: 2, heal: 10 }).setKey("Intends\nto Rest"),
            new Action({ enemy: 1, turn: 3, damage: 13 }).setKey(""),
            new Action({ enemy: 1, turn: 4, heal: 10 }).setKey("Intends\nto Rest"),
            new Action({ enemy: 1, turn: 5, debuffCard: 'discard' }).setKey(`Intends to\nApply a debuff`),

            // Random turns
            new Action({ enemy: 1, damage: 12, probability: 0.35 }).setKey(""),
            new Action({ enemy: 1, damage: 16, probability: 0.15 }).setKey(""),
            new Action({ enemy: 1, heal: 10, armor: 1, probability: 0.15 }).setKey("Intends\nto Rest"),
            new Action({ enemy: 1, debuffCard: 'discard', probability: 0.15 }).setKey(`Intends to\nApply a debuff`),
            new Action({ enemy: 1, armor: 2, probability: 0.10 }).setKey(`Intends to\nApply a buff`),
            new Action({ enemy: 1, strength: 2, probability: 0.10 }).setKey(`Intends to\nApply a buff`),
        ];
        ...
        gameState.enemy2.actions = [
            // Predetermined turns
            new Action({ enemy: 2, turn: 1, debuffCard: 'discard' }).setKey(`Intends to\nApply a debuff`),
            new Action({ enemy: 2, turn: 2, heal: 10 }).setKey("Intends\nto Rest"),
            new Action({ enemy: 2, turn: 3, damage: 15 }).setKey(""),
            new Action({ enemy: 2, turn: 4, heal: 10 }).setKey("Intends\nto Rest"),
            new Action({ enemy: 2, turn: 5, debuffCard: 'discard' }).setKey(`Intends to\nApply a debuff`),

            // Random turns
            new Action({ enemy: 2, damage: 14, probability: 0.35 }).setKey(""),
            new Action({ enemy: 2, damage: 18, probability: 0.20 }).setKey(""),
            new Action({ enemy: 2, heal: 10, armor: 1, probability: 0.15 }).setKey("Intends\nto Rest"),
            new Action({ enemy: 2, debuffCard: 'discard', probability: 0.15 }).setKey(`Intends to\nApply a debuff`),
            new Action({ enemy: 2, strength: 2, probability: 0.15 }).setKey(`Intends to\nApply a buff`),
        ];
        ...
        async function initiatePlayersTurnOneEvent() {
            ...
            const textConfig = { fontSize: '50px', fill: '#ff0000', fontWeight: 'bold' };
