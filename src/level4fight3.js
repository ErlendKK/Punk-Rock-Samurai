...
class Level4Fight3 extends BaseScene {
    ...
    preload() {
        const assets = [
            { key: 'bakgrunnFortress3', path: '../assets/images/backgrounds/bakgrunnFortress3.jpg', loaded: false },
            { key: 'monster5', path: '../assets/images/sprites/monster5.png', loaded: false },
            { key: 'monster2', path: '../assets/images/sprites/monster2.png', loaded: false },
            { key: 'sorcerer2', path: '../assets/images/sprites/sorcerer2.png', loaded: false },
    ...
    create() {
        ...
        gameState.enemy3.actions = [
            // First turns
            new Action({ enemy: 3, turn: 1, debuffCard: 'draw' }).setKey(`Intends to\nApply a debuff`),
            new Action({ enemy: 3, turn: 2, strength: 2, armor: 3, teamEffect: true }).setKey(`Intends to\nBuff team`),

            // Predetermined pattern
            new Action({ enemy: 3, fire: 5, pattern: 'oneInThree' }).setKey(`Intends to\nDeal 5 fire damage`),
            new Action({ enemy: 3, heal: 10, teamEffect: true, pattern: 'twoInThree' }).setKey(`Intends to\nBuff his team`),
            new Action({ enemy: 3, fire: 7, pattern: 'threeInThree' }).setKey(`Intends to\nDeal 7 fire damage`),
        ];
