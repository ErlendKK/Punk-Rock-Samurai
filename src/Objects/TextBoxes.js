...
class TextBox {
    constructor(scene, textContent, argCoords = {}, textConfig = {}, backgroundAlpha = 0.5) {
        // Default properties for text coordinates and Configurations
        const defaultCoords = {
            x: 0, y: 0, z: 200
        };
        const defaultTextConfig = {
            fontSize: 50, fill: '#ff0000', fontWeight: ''
        };
    ...
    setConfig(configArg, radius = 7, alpha = 0.40) {
