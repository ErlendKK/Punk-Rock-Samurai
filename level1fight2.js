...
class Level1Fight2 extends BaseScene {self
    ...
    create() {
        ...
        gameState.enemy1.name = 'Police Officer';
        gameState.enemy1.sprite = this.add.sprite(700, 350, 'police1').setScale(0.22).setFlipX(true).setInteractive(); //690 / 350 / .33
        gameState.enemy1.health = 40;
        gameState.enemy1.healthMax = 40;  
            
        gameState.enemy2  = Object.create(gameState.enemy);
        gameState.enemy2.name = 'Police Officer';
        gameState.enemy2.sprite = this.add.sprite(870, 350, 'police2').setScale(0.33).setFlipX(true).setInteractive(); //910 / 310 / .25
