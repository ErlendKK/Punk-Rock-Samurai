class Level1fight2 extends BaseScene {
    ...
    create() {
        ...
        gameState.enemy1 = {
            name: 'Police Officer',
            sprite: this.add.sprite(700, 350, 'police1').setScale(0.22).setFlipX(true).setInteractive(), //690 / 350 / .33
        ...
        gameState.enemy2 = {
            name: 'Police Officer',
            sprite: this.add.sprite(870, 350, 'police2').setScale(0.33).setFlipX(true).setInteractive(), //910 / 310 / .25
            healthBarColor: '0xff0000',
            alive: true,
            actions: [],        
        ...
        function startFight() {     
            self.time.delayedCall(600, () => { 
                ...
                self.time.delayedCall(2000, () => { //timer: 1500
    ...
    function updateEnemyActions() {
        ...
        if (gameState.turn === 1) {
            gameState.enemy1.actions = [
                {key: `Intends to\nApply a buff`, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 6, text: 'Gains 6 armor', probability: 1},
            ] 
