...
class Level4Fight3 extends BaseScene {self
    constructor() {
        super('Level4Fight3');
    }

    preload() {
        this.load.image('bakgrunnFortress3', 'assets/images/bakgrunnFortress3.jpg'); 
        this.load.image('monster5', 'assets/images/sprites/monster5.png');
        this.load.image('monster2', 'assets/images/sprites/monster2.png');
        this.load.image('sorcerer2', 'assets/images/sprites/sorcerer2.png');
    ...
    create() {
        ...
        this.baseCreate('bakgrunnFortress3', sceneKey);
        this.resetPlayer(gameState.player, 0.33, 300, 370); //l1f1:0.28 -- l1f2: 0.24, 360, 300 (liten:0.48, 360, 280)
        ...
        gameState.enemy1.sprite = this.add.sprite(580, 370, 'monster2').setScale(0.31).setFlipX(false).setInteractive(); //710 / 350 / .33
        ...
        gameState.enemy2.sprite = this.add.sprite(750, 370, 'monster5').setScale(0.48).setFlipX(false).setInteractive(); //710 / 350 / .33
        ...
        gameState.enemy3.sprite = this.add.sprite(920, 340, 'sorcerer2').setScale(0.26).setFlipX(false).setInteractive(); //710 / 350 / .33
    ...
    // ---------------------------------- ENEMY'S TURN -------------------------------------      
        ...
        function updateEnemyActions() {
            ...
            if (gameState.turn === 1) {
                ...
                gameState.enemy3.actions = [
                    {key: `Intends to\nBuff team`, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 1, armor: 3, text: 'Team gains 2 Strength and 3 Armor', probability: 1},
                ];
                
            } else { 
    
                gameState.enemy3.actions = [ 
                    {key: `Intends to\nDeal 7 fire damage`, damage: 0, fire: 5, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: `Deals 5 fire damage`, probability: 0.50},
                    {key: `Intends to\nDeal 7 fire damage`, damage: 0, fire: 7, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: `Deals 7 fire damage`, probability: 0.20},
                    {key: `Intends to\nBuff Team`, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 2, armor: 3, text: 'Team gains 1 Strength and 2 armor', probability: 0.30},
                ];
