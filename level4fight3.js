...
class Level4Fight3 extends BaseScene {self
    ...
    create() {
        const self = this;      
        this.baseCreate('bakgrunnFortress3', 0.70); //BaseScene method  
    ...
    function updateEnemyActions() {
        ...
        if (gameState.turn === 1) {
            gameState.enemy1.actions = [
                {key: `Intends to\nSteal Armor`, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 4, text: 'Steals 4 Armor', probability: 1},
            ] 
            ...
            gameState.enemy1.actions = [ 
                {key: `Intends to\nDeal 5 fire damage`, damage: 0, fire: 5, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 1, reduceTargetStrength: 0, reduceTargetArmor: 1, text: `Deals 5 fire damage`, probability: 0.11 + ((gameState.enemy1.health >= gameState.enemy1.healthMax) ? 0.22 : 0) / 5},
        ...
        if (gameState.turn === 1) {
            gameState.enemy3.actions = [
                {key: `Intends to\nBuff team`, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 3, armor: 4, text: 'Team gains 3 Strength and 4 Armor', probability: 1},
            ]
            
         } else { 

            gameState.enemy3.actions = [ 
                {key: `Intends to\nDeal 7 fire damage`, damage: 0, fire: 5, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: `Deals 7 fire damage`, probability: 0.70},
                {key: `Intends to\nBuff Team`, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 2, armor: 3, text: 'Team gains 2 Strength and 3 armor', probability: 0.30},
            ]
