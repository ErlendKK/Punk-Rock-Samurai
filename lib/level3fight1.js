...
class Level3Fight1 extends BaseScene {
  constructor() {
    super('Level3Fight1');
  }
  preload() {
    const assets = [{
      key: 'bakgrunnLair1',
      path: '../assets/images/backgrounds/bakgrunnLair1.jpg',
      loaded: false
    }, {
      key: 'theDemonLair',
      path: '../assets/images/backgrounds/theDemonLair.jpg',
      loaded: false
    }, {
      key: 'voidling',
      ...
      key: 'demon2',
      path: '../assets/images/sprites/demon2.png',
      loaded: false
    }, {
      key: 'hellFire',
  ...
  create() {
    ...
    this.baseCreate('bakgrunnLair1', sceneKey);
    ...
    const enemy1Health = self.adjustForDifficulty(70, 75, 80);
    gameState.enemy1 = new Enemy('Infernus', enemy1Health, 0, 0, 'hellFire');
    gameState.enemy1.sprite = this.add.image(1260, 473, 'demon2').setScale(0.45).setFlipX(false);
    const summonArgs = {
      x: 945,
      y: 555,
      health: 25,
    ...
    new Action({
      ...
      probability: () => isSummoned() ? 0 : 1
    }).setKey("Intends to\nSummon a Voidling"), new Action({
      enemy: 1,
      fire: 7,
      probability: () => isSummoned() ? 0.2 : 0
    }).setKey("Intends to\nDeal 7 Fire Damage"), new Action({
      enemy: 1,
      damage: 15,
      probability: () => isSummoned() ? 0.3 : 0
    }).setKey(""), new Action({
      enemy: 1,
      damage: 18,
      probability: () => isSummoned() ? 0.1 : 0
    }).setKey(""), new Action({
      enemy: 1,
      heal: 10,
      armor: 3,
      ...
      heal: 10,
      strength: 2,
      probability: () => isSummoned() ? 0.15 : 0
    }).setKey("Intends to\nApply a buff"), new Action({
      enemy: 1,
      debuffCard: 'draw',
      probability: () => isSummoned() ? 0.15 : 0
    }).setKey("Intends to\nApply a debuff")];
    gameState.enemy2 = new Enemy('Voidling', 25, 0, 0, 'hellFire');
    gameState.enemy2.sprite = this.add.image(945, 555, 'voidling').setScale(0.45).setFlipX(false);
