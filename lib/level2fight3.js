...
class Level2Fight3 extends BaseScene {
  constructor() {
    super('Level2Fight3');
  }
  preload() {
    const assets = [{
      key: 'bakgrunnForest3',
      path: '../assets/images/backgrounds/bakgrunnForest3.jpg',
      loaded: false
    }, {
      key: 'tree3',
      path: '../assets/images/sprites/tree3.png',
      loaded: false
    }, {
      key: 'rooted',
      path: '../assets/images/cards/rooted.jpg',
      loaded: false
    }, {
      key: 'goblin',
  ...
  create() {
    ...
    this.baseCreate('bakgrunnForest3', sceneKey);
    this.resetPlayer(0.555, 540, 545);
    this.addGoldCounter();
    ...
    const enemyHealth = self.adjustForDifficulty(80, 100, 110);
    const summonArgs = {
      x: 840,
      y: 588,
      health: 30,
    ...
    const isSummoned = () => {
      var _gameState$enemy;
      return (_gameState$enemy = gameState.enemy2) === null || _gameState$enemy === void 0 ? void 0 : _gameState$enemy.alive;
    };
    gameState.enemy1 = new Enemy('Jubokko Lord', enemyHealth, 0, 15, 'rooted');
    gameState.enemy1.sprite = this.add.image(1170, 435, 'tree3').setScale(0.54).setFlipX(false);
    ...
    function reduceArmorLevel2(cardEffects, target) {
      const isRelevant = () => target != gameState.player && target.armor && cardEffects.damageTotal;
    ...
    async function startPlayersTurn(tweensDelay) {
      ...
      console.log("Turn: ".concat(gameState.playersTurn));
    ...
    function handleAttackEffects(cardEffects, target) {
      ...
      if (target === gameState.enemy1) {
        // NB! Only for level 2!
        reduceArmorLevel2(cardEffects, target); // NB! Only for level 2!
      } // NB! Only for level 2!
    ...
    */
    ...
    function summonNewEnemy(summonEnemy) {
      ...
      gameState[ID] = new Enemy(NamePropper, health, 0, 0, "");
      gameState[ID].sprite = self.add.image(x, y, name).setScale(0.25).setAlpha(0).setFlipX(true);
    ...
    function fadeInEnemy(enemy, duration) {
      self.tweens.add({
        ...
        onComplete: function onComplete() {
          ...
          enemy.setScene(self).setSpriteAttributes().addHealthBar().addStatsDisplay(685);
