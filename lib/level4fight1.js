...
class Level4Fight1 extends BaseScene {
  constructor() {
    super('Level4Fight1');
  }
  preload() {
    const assets = [{
      key: 'bakgrunnFortress1',
      path: '../assets/images/backgrounds/bakgrunnFortress1.jpg',
      loaded: false
    }, {
      key: 'theFortress',
      path: '../assets/images/backgrounds/theFortress.jpg',
      loaded: false
    }, {
      key: 'monster1',
      path: '../assets/images/sprites/monster1.png',
      loaded: false
    }, {
      key: 'monster2',
  ...
  create() {
    ...
    this.baseCreate('bakgrunnFortress1', sceneKey);
    this.resetPlayer(0.465, 540, 563);
    this.addGoldCounter();
    ...
    const enemy1Health = self.adjustForDifficulty(55, 60, 65);
    gameState.enemy1 = new Enemy('Mong\nSteals Armor', enemy1Health, 0, 0, 'monstrosity');
    gameState.enemy1.sprite = this.add.image(900, 548, 'monster1').setScale(0.34).setFlipX(false);
    ...
    const enemy2Health = self.adjustForDifficulty(60, 70, 80);
    gameState.enemy2 = new Enemy('Goh\nSteals Strength', enemy2Health, 0, 0, 'monstrosity');
    gameState.enemy2.sprite = this.add.image(1170, 555, 'monster2').setScale(0.51).setFlipX(false);
    ...
    gameState.characters.forEach(character => {
      character.setScene(this).setSpriteAttributes().addHealthBar().addManaBar().addStatsDisplay(690);
    ...
    function welcomePlayerToLevel() {
      const levelimage = self.add.image(0, 0, 'theFortress');
      ...
      const leveltextTop = self.add.text(825, 405, 'Level 4:', levelTextConfig);
      const leveltextBottom = self.add.text(825, 645, 'The Fortress', levelTextConfig);
    ...
    async function initiatePlayersTurnOneEvent() {
      ...
      const textContent = "Heads up: Monsters steal\nStrength and Armor!";
      const turnOneText = new TextBox(self, textContent, textCoordinates, textConfig, 0.7);
