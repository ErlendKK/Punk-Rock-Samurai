...
class Level2Fight1 extends BaseScene {
  ...
  preload() {
    const assets = [{
      key: 'theForest',
      path: '../assets/images/backgrounds/theForest.jpg',
      loaded: false
    }, {
      key: 'bakgrunnForest1',
      path: '../assets/images/backgrounds/bakgrunnForest1.jpg',
      loaded: false
    }, {
      key: 'tree1',
      path: '../assets/images/sprites/tree1.png',
      loaded: false
    }, {
      key: 'tree2',
      path: '../assets/images/sprites/tree2.png',
      loaded: false
    }, {
      key: 'rooted',
  ...
  create() {
    ...
    this.resetPlayer(0.550, 540, 545);
    this.addGoldCounter();
    ...
    const enemy1Health = self.adjustForDifficulty(45, 50, 55);
    gameState.enemy1 = new Enemy('Jubokko Jr.', enemy1Health, 0, 15, 'rooted');
    gameState.enemy1.sprite = this.add.image(1020, 473, 'tree1').setScale(0.48).setFlipX(false);
    ...
    const enemy2Health = self.adjustForDifficulty(50, 60, 65);
    gameState.enemy2 = new Enemy('Jubokko Sr.', enemy2Health, 0, 15, 'rooted');
    gameState.enemy2.sprite = this.add.image(1380, 473, 'tree2').setScale(0.48).setFlipX(false);
    ...
    function welcomePlayerToLevel() {
      const levelimage = self.add.image(0, 0, 'theForest');
      ...
      const leveltextTop = self.add.text(825, 405, 'Level 2:', levelTextConfig);
      const leveltextBottom = self.add.text(825, 645, 'Aokigahara Forest', levelTextConfig);
    ...
    async function initiatePlayersTurnOneEvent() {
      ...
      const textContent = "Trees start with\nfull Armor, and lose\n1 Armor when attacked";
      const turnOneText = new TextBox(self, textContent, textCoordinates, textConfig);
      await self.delay(3500);
      turnOneText.fadeOut();
    }
