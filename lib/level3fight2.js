...
class Level3Fight2 extends BaseScene {
  constructor() {
    super('Level3Fight2');
  }
  preload() {
    const assets = [{
      key: 'bakgrunnLair2',
      path: '../assets/images/backgrounds/bakgrunnLair2.jpg',
      loaded: false
    }, {
      key: 'skeleton1',
      path: '../assets/images/sprites/skeleton1.png',
      loaded: false
    }, {
      key: 'skeleton2',
      path: '../assets/images/sprites/skeleton2.png',
      loaded: false
    }, {
      key: 'voidling',
  ...
  create() {
    ...
    this.baseCreate('bakgrunnLair2', sceneKey);
    this.resetPlayer(0.63, 480, 533);
    this.addGoldCounter();
    ...
    const enemy1Health = self.adjustForDifficulty(80, 100, 120);
    gameState.enemy1 = new Enemy('Bonebaron', enemy1Health, 0, 0, 'hellFire');
    gameState.enemy1.sprite = this.add.image(1245, 465, 'skeleton2').setScale(0.525).setFlipX(false);
    const summonArgs1 = {
      x: 975,
      y: 557,
      health: 25,
    ...
    const isSummoned2 = () => {
      var _gameState2;
      return (_gameState2 = gameState) === null || _gameState2 === void 0 || (_gameState2 = _gameState2.enemy3) === null || _gameState2 === void 0 ? void 0 : _gameState2.alive;
    };
    const isAllSummoned = () => isSummoned1() && isSummoned2();
    gameState.enemy1.actions = [
    // Summon enemies
    new Action({
      enemy: 1,
      summonEnemy: summonArgs1,
      probability: () => isSummoned1() ? 0 : 1
    }).setKey("Intends to\nSummon a Voidling"), new Action({
      enemy: 1,
      summonEnemy: summonArgs2,
      probability: () => isSummoned2() || !isSummoned1() ? 0 : 1
    }).setKey("Intends to\nSummon a Voidling"),
    // Other actions
    new Action({
      enemy: 1,
      fire: 5,
      probability: () => isAllSummoned() ? 0.20 : 0
    }).setKey("Intends to\nDeal 5 Fire Damage"), new Action({
      enemy: 1,
      damage: 15,
      probability: () => isAllSummoned() ? 0.30 : 0
    }).setKey(""), new Action({
      enemy: 1,
      damage: 17,
      probability: () => isAllSummoned() ? 0.20 : 0
      ...
      heal: 10,
      armor: 3,
      probability: () => isAllSummoned() ? 0.10 : 0
