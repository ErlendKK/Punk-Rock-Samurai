...
class Button {
  constructor(scene, key, handler, x, y) {
    let z = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 201;
    let scaleX = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 0.60;
    let scaleY = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : 0.60;
    this.scene = scene;
    this.key = key;
    ...
    this.label = scene.add.text(x, y, key, {
      fontSize: '25px',
      fill: '#000000'
    });
  ...
  updateFont(fontSize) {
    let fill = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '#000000';
