...
class Action {
  ...
  get text() {
    let textOutput = [];
    if (this.damage || this.fire) textOutput.push("Deals ".concat(this.damage + this.fire, " Damage"));
    if (this.poison) textOutput.push("Deals ".concat(this.poison, " Poison"));
    if (this.heal) textOutput.push("Heals ".concat(this.heal, " HP"));
    if (this.strength) textOutput.push("Gains ".concat(this.strength, " Strength"));
    if (this.armor) textOutput.push("Gains ".concat(this.armor, " Armor"));
    if (this.debuffCard) textOutput.push("Applies a debuff");
    if (this.skip) textOutput.push('Skips a Turn');
    if (this.summon) textOutput.push("Summons\na ".concat(this.summonEnemy.name));
    if (this.stealStrength) textOutput.push("Steals ".concat(this.stealStrength, " Strength"));
    if (this.stealArmor) textOutput.push("Steals ".concat(this.stealArmor, " Armor"));
    if (this.teamEffect && this.heal) textOutput.push("Heals allies ".concat(this.heal, " HP"));
