...
class Level4Fight3 extends BaseScene {
  constructor() {
    super('Level4Fight3');
  }
  preload() {
    const assets = [{
      key: 'bakgrunnFortress3',
      path: '../assets/images/backgrounds/bakgrunnFortress3.jpg',
      loaded: false
    }, {
      key: 'monster5',
      path: '../assets/images/sprites/monster5.png',
      loaded: false
    }, {
      key: 'monster2',
      path: '../assets/images/sprites/monster2.png',
      loaded: false
    }, {
      key: 'sorcerer2',
      path: '../assets/images/sprites/sorcerer2.png',
      loaded: false
    }, {
      key: 'monstrosity',
  ...
  create() {
    ...
    this.baseCreate('bakgrunnFortress3', sceneKey, 1.2);
    ...
    const enemy1Health = self.adjustForDifficulty(40, 45, 50);
    gameState.enemy1 = new Enemy('Goh Resurrected\nSteals Armor', enemy1Health, 0, 0, 'monstrosity');
    gameState.enemy1.sprite = this.add.image(870, 555, 'monster2').setScale(0.465).setFlipX(false);
    const enemy2Health = self.adjustForDifficulty(50, 55, 60);
    gameState.enemy2 = new Enemy('Terrorsnout\nSteals Strength and Armor', enemy2Health, 0, 0, 'monstrosity');
    gameState.enemy2.sprite = this.add.image(1125, 555, 'monster5').setScale(0.72).setFlipX(false);
    const enemy3Health = self.adjustForDifficulty(70, 80, 90);
    gameState.enemy3 = new Enemy('Necronis\nMaster of fire', enemy3Health, 0, 0, 'monstrosity');
    gameState.enemy3.sprite = this.add.image(1380, 530, 'sorcerer2').setScale(0.35).setFlipX(false);
    ...
    new Action({
      ...
      fire: 5,
      pattern: 'oneInThree'
    }).setKey("Intends to\nDeal 5 fire damage"), new Action({
      enemy: 3,
      heal: 10,
      teamEffect: true,
      pattern: 'twoInThree'
    }).setKey("Intends to\nBuff his team"), new Action({
      enemy: 3,
      fire: 7,
      pattern: 'threeInThree'
    }).setKey("Intends to\nDeal 7 fire damage")];
    ...
    async function initiatePlayerTurn() {
      ...
      gameState.enemy3.actions.forEach(action => console.log(action.key)); //Remove this
    ...
    */
    ...
    function handleEnemySteal(enemy, chosenAction) {
      ...
      self.updateTextAndBackground(gameState.actionText, gameState.actionTextBackground, chosenAction.text);
      enemy.gainStrengthAndArmor(chosenAction.stealStrength, chosenAction.stealArmor);
      enemy.powerUpTweens();
