class Level3fight1 extends BaseScene {
    ...
    create() {   
        ...
        gameState.enemy1 = {
            name: 'Voidling',
            sprite: this.add.sprite(680, 350, 'demon1').setScale(0.32).setFlipX(false).setInteractive(), //690 / 350 / .33
            alive: true,
            actions: [],         
            health: 50,
            healthMax: 50,
        ...
        gameState.enemy2 = {
            name: 'Infernus',
            sprite: this.add.sprite(890, 330, 'demon2').setScale(0.26).setFlipX(false).setInteractive(), //910 / 310 / .25
            alive: true,
            actions: [],        
        ...
        let level3image = this.add.image(0,0, 'theDemonLair').setScale(0.87).setOrigin(0.02,0).setDepth(300);
        let level3textTop = this.add.text(550, 270, 'Level 3:', levelTextConfig).setDepth(301).setOrigin(0.5);
        let level3textBottom = this.add.text(550, 430, 'The Demon Lair', levelTextConfig).setDepth(301).setOrigin(0.5);
