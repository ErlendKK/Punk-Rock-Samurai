    ...
    // ---------------------------------- ENEMY'S TURN -------------------------------------      
        ...
        function updateEnemyActions() {
            ...
            if (gameState.turn === 1) {
                ...
                gameState.enemy1.actions = [ 
                    {key: `Intends to\nDeal 5 fire damage`, damage: 0, fire: 5, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: `Deals 5 Fire damage`, probability: 0.20 + ((gameState.enemy1.health >= gameState.enemy1.healthMax) ? 0.20 : 0) / 5},
                    ...
                    {key: `Intends to\nApply a buff`, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 3, armor: 0, text: 'Gains 3 Strenght', probability: 0.09 + ((gameState.enemy1.health >= gameState.enemy1.healthMax) ? 0.20 : 0) / 5},
