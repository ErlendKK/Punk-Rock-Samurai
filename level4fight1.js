...
class Level4Fight1 extends BaseScene {
    ...
    preload() {
        this.load.image('bakgrunnFortress1', 'assets/images/backgrounds/bakgrunnFortress1.jpg');
        this.load.image('theFortress', 'assets/images/backgrounds/theFortress.jpg');
