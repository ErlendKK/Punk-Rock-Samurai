...
class Level2Fight1 extends BaseScene {
    ...
    preload() {
        this.load.image('theForest', 'assets/images/backgrounds/theForest.jpg');
        this.load.image('bakgrunnForest1', 'assets/images/backgrounds/bakgrunnForest1.jpg');
        this.load.image('tree1', 'assets/images/sprites/tree1.png');
        this.load.image('tree2', 'assets/images/sprites/tree2.png');
        this.load.image('rooted', 'assets/images/cards/rooted.jpg');
    }; 
