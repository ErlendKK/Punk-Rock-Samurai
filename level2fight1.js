...
class Level2Fight1 extends BaseScene {self
    constructor() {
        super('Level2Fight1');
    }
    ...
    create() {
        const self = this;      
        this.baseCreate('bakgrunnForest1'); //BaseScene method  
        ...
        gameState.enemy1.sprite = this.add.sprite(690, 330, 'tree1').setScale(0.29).setFlipX(false).setInteractive(); //690 / 350 / .33
        ...
        gameState.enemy2.sprite = this.add.sprite(920, 330, 'tree2').setScale(0.29).setFlipX(false).setInteractive(), //910 / 310 / .25
        ...
        this.addStanceBar(gameState.player, '#2e2e2e'); // Grey: a9a9a9; dark grey: #2e2e2e
        ...
        const levelimage = this.add.image(0,0, 'theForest').setScale(0.87).setOrigin(0.02,0).setDepth(300);
        const leveltextTop = this.add.text(550, 270, 'Level 2:', levelTextConfig).setDepth(301).setOrigin(0.5);
        const leveltextBottom = this.add.text(550, 430, 'The Forest', levelTextConfig).setDepth(301).setOrigin(0.5); 
    ...
    function updateEnemyActions() {
        ...
        if (gameState.turn === 1) {
            ...
            gameState.enemy1.actions = [ 
                ...
                {key: `Intends to\nApply a buff`, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 2, armor: 0, text: 'Gains 2 strenght', probability: 0.120 + ((gameState.enemy1.health >= gameState.enemy1.healthMax) ? 0.22 : 0) / 5},
    ...
    function selectEnemyAction(enemy) {
        ...
        function startNextLevel() {
            ...
            self.scene.start('Level2Fight2'); //sett lik neste level
            });
        }
