...
class Level1Fight3 extends BaseScene {self
    ...
    create() {
        ...
        gameState.enemy1.sprite = this.add.image(680, 340, 'police1').setScale(0.255).setFlipX(true).setInteractive(); //740 / 360 / .42
        ...
        gameState.enemy2.sprite = this.add.image(840, 340, 'police2').setScale(0.39).setFlipX(true).setInteractive(); //740 / 360 / .42
            ...
            if (gameState.playersTurn) { 
                ...
                self.time.delayedCall(1500, () => {
                    ...
                    if (gameState.turn === 1) { // NB! Lever-specific function
                        ...
                        enemyTextBackground.fillRoundedRect(enemyText.x - (textWidth / 2) - paddingX, enemyText.y - (textHeight / 2) - paddingY, textWidth + 2 * paddingX, textHeight + 2 * paddingY, cornerRadius).setDepth(200);
                        ...
                        self.time.delayedCall(3500, () => {
                            ...
                            policeTextBackground.fillRoundedRect(policeText.x - (textWidth / 2) - paddingX, policeText.y - (textHeight / 2) - paddingY, textWidth + 2 * paddingX, textHeight + 2 * paddingY, cornerRadius).setDepth(200);
                ...
                gameState.enemies.forEach (enemy => {
                    ...
                    enemy.sprite.on('pointerup', function() {
                        if (enemy.health < 30 && functionActive) {
                            ...
                            removeIfDead(enemy);
                            if (!checkGameOver()) updateStrengthAndArmor(gameState.player);
