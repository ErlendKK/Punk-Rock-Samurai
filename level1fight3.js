...
class Level1Fight3 extends BaseScene {self
    ...
    create() {
        ...
        gameState.enemy1.name = 'Police Informant';
        gameState.enemy1.sprite = this.add.sprite(700, 340, 'skinhead1').setScale(0.25).setFlipX(false).setInteractive(); //690 / 350 / .33
        gameState.enemy1.health = 60;
        gameState.enemy1.healthMax = 60;  
            
        gameState.enemy2  = Object.create(gameState.enemy);
        gameState.enemy2.name = 'Police Informant';
        gameState.enemy2.sprite = this.add.sprite(880, 340, 'skinhead2').setScale(0.38).setFlipX(false).setInteractive(); //910 / 310 / .25
        ...
        function startPlayerTurn() { //NB! LEVEL-SPECIFIC FUNCTION: don't copy elsewhere!
            ...
            if (turnsTillPoliceArrive === 0) {
                ...
                self.time.delayedCall(2200, () => { //timer: 2200
                    ...
                    // Must be called after gameState.turn is increased
