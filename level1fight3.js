class Level1fight3 extends BaseScene {
    ...
    preload() {
        ...
        this.load.image('skinhead1', 'assets/images/sprites/skinhead1.png');
        this.load.image('skinhead2', 'assets/images/sprites/skinhead2.png');
        };
    ...
    function startEnemyTurn(enemy) { // NB! LEVEL-SPECIFIC FUNCTION! Do not copy elsewhere!
        ...
        if (gameState.playersTurn) { // This is called here to ensure that "Enemy turn" is only declared once eventhough multiple enemies play their turns.
            ...
            self.time.delayedCall(1800, () => {
                ...
                if (gameState.turn === 1) {
                    ...
                    const enemyText = self.add.text(550, 300, '  The enemy is\nratting you out!', textConfig).setOrigin(0.5).setDepth(201);
    ...
    function updateEnemyActions() {
        ...
        if (gameState.turn === 1) {
            gameState.enemy1.actions = [ 
                {key: `Intends to\nRat you out`, damage: 0, fire: 0, poison: 0, heal: 0, poisonRemove: 0, strength: 0, armor: 0, text: 'Rats you out', probability: 1},
            ]
    ...
    function selectEnemyAction(enemy) {
        ...
        function initiateDefeat() {
            ...
            gameState.gameOverText = self.add.text(550, 300, ' Defeat!', { fontSize: '110px', fill: '#ff0000', fontFamily: 'Rock Kapak' }).setOrigin(0.5);
        ...
        function initiateVictory() {
            ...
            let victoryText = self.add.text(550, 300, 'Victory!', { fontSize: '110px', fill: '#ff0000', fontFamily: 'Rock Kapak' }).setOrigin(0.5);
        ...
        function chooseReward() {
            ...
            gameState.rewardAddCardsButton = self.add.image(550, 350, 'rectangularButton').setScale(1.2).setInteractive().setOrigin(0.5).setDepth(102);
    ...
    // ---------------------------------- UTILITIES-------------------------------------      
        ...
        function clearBoard() {
            ...
            gameState.turnsTextBox.destroy();
            gameState.turnsText.destroy();
