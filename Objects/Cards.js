...
class Cards extends Phaser.Scene {
    ...
    create() {
        ...
        const startingDeckDefinitions = [
            { key: 'knuckleFist', type: 'targetSelected', cost: 1, stancePoints: 1, damage: 7, poison: () => gameState.toxicFrets ? 1 : 0 },
            { key: 'knuckleFist', type: 'targetSelected', cost: 1, stancePoints: 1, damage: 7, poison: () => gameState.toxicFrets ? 1 : 0 },
            { key: 'knuckleFist', type: 'targetSelected', cost: 1, stancePoints: 1, damage: 7, poison: () => gameState.toxicFrets ? 1 : 0 },
            { key: 'knuckleFist', type: 'targetSelected', cost: 1, stancePoints: 1, damage: 7, poison: () => gameState.toxicFrets ? 1 : 0 },

            { key: 'kabutu',      type: () => (gameState.edoEruption && gameState.player.stancePoints > 0) ? 'targetAll' : 'buff', cost: 1, stancePoints: -1, armor: 5 },
            { key: 'kabutu',      type: () => (gameState.edoEruption && gameState.player.stancePoints > 0) ? 'targetAll' : 'buff', cost: 1, stancePoints: -1, armor: 5 },
            { key: 'kabutu',      type: () => (gameState.edoEruption && gameState.player.stancePoints > 0) ? 'targetAll' : 'buff', cost: 1, stancePoints: -1, armor: 5 },
        ...
        const bonusCardDefinitions = [
            ...
            { key: 'ashenEncore', type: 'permanent', cost: 1, token: 'ashenEncoreToken' },
            { key: 'punksNotDead', type: 'permanent', cost: 1, token: 'punksNotDeadToken' },
            { key: 'toxicAvenger', type: 'permanent', cost: 1, token: 'toxicAvengerToken' },
            { key: 'bushido', type: 'permanent', cost: 1, token: 'bushidoToken' },
            ...
            { key: 'masakari', type: 'targetSelected', cost: 2, damage: () => gameState.player.stancePoints < 0 ? 10 * (1 - gameState.player.stancePoints * gameState.player.strength / 10) : 10 },
            { key: 'pyromania', type: 'targetSelected', cost: 2, fire: 15 },
            { key: 'roninsRot', type: 'targetSelected', cost: 1, drawCard: () => (gameState.player.stancePoints > 0) ? 1 : 0 },
            { key: 'dogsOfWar', type: 'targetSelected', cost: 1, stancePoints: 1, damage: 9 },
            { key: 'libertySpikes', type: 'targetSelected', cost: 1, damage: 5, armor: () => gameState.player.stancePoints < 0 ? 2 : 0, drawCard: () => (gameState.player.stancePoints > 0) ? 1 : 0 },
            { key: 'bladesBlight', type: 'targetSelected', cost: 3 },
            { key: 'scorchedSoul', type: 'targetSelected', cost: 1, fire: 7 },
        ...
        const extraCardDefinitions = [
            { key: 'enduringSpirit', type: 'permanent', cost: 1, token: 'enduringSpiritToken' },
            { key: 'lustForLife',    type: 'permanent', cost: 1, token: 'lustForLifeToken' },
            { key: 'soulSquatter',   type: 'permanent', cost: 1, token: 'soulSquatterToken' },
            { key: 'gundanSeizai',   type: 'permanent', cost: 1, token: 'gundanSeizaiToken' },
            { key: 'rebelHeart',     type: 'permanent', cost: 1, token: 'rebelHeartToken' },
            { key: 'kirisuteGomen',  type: 'permanent', cost: 1, token: 'kirisuteGomenToken' },
            { key: 'deadTokugawas',  type: 'permanent', cost: 1, token: 'deadTokugawasToken' }
        ];
        ...
        const steelToeCardDefinitions = [
            { key: 'steelToe2', type: 'permanent', cost: 1, goldCost: 1, token: 'steelToeToken' }
        ];
        ...
        gameConfig.cardDefinitions = [
            ...startingDeckDefinitions, 
            ...bonusCardDefinitions, 
            ...extraCardDefinitions, 
            ...bouncingSolesCardDefinitions, 
            ...steelToeCardDefinitions, 
            ...zaibatsuCardDefinitions
        ];
