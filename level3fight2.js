...
class Level3Fight2 extends BaseScene {self
    ...
    create() {
        const self = this;      
        this.baseCreate('bakgrunnLair2'); //BaseScene method  
        ...
        gameState.enemy1.sprite = this.add.sprite(690, 350, 'skeleton1').setScale(0.26).setFlipX(false).setInteractive(), //690 / 350 / .33
        ...
        gameState.enemy2.sprite = this.add.sprite(910, 330, 'skeleton2').setScale(0.26).setFlipX(false).setInteractive(), //910 / 310 / .25
