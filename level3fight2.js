class Level3fight2 extends BaseScene {
    ...
    create() {   
        ...
        gameState.enemy1 = {
            name: 'Spineguard',
            sprite: this.add.sprite(690, 350, 'skeleton1').setScale(0.26).setFlipX(false).setInteractive(), //690 / 350 / .33
            alive: true,
            actions: [],         
            health: 50,
            healthMax: 50,
        ...
        gameState.enemy2 = {
            name: 'Bonebaron',
            sprite: this.add.sprite(910, 330, 'skeleton2').setScale(0.26).setFlipX(false).setInteractive(), //910 / 310 / .25
            alive: true,
            actions: [],        
